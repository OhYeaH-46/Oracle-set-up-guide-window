...
info "ติดตั้ง status line จาก github.com/Siwatch-OhYeaH/claude-statusline..."
curl -fsSL https://raw.githubusercontent.com/Siwatch-OhYeaH/claude-statusline/master/install.sh | bash
success "Status line พร้อมแล้ว"
